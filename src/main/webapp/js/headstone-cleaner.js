		...
		template: '<div>' +
					'<div class="description">' +
						...
						'<div ng-show="showDescription" align="left">' +
							...
							'<h3>Contact</h3>For further information or questions please contact me at <a href="' + 'mail' + 'to:' + '{{username}}' + '@' + '{{hostname}}' + '.com">' + '{{linktext}}' + '</a>.' +
							'<br /><br /><b></b>' +
							'<br /><br />' + 
...
,
		link: function(scope, element, attrs){
			...
			scope.username = "cam";
			scope.hostname = "camjacv";
			scope.linktext = scope.username + "@" + scope.hostname + ".com";
